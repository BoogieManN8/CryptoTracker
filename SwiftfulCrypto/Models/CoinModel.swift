...
// Coingecko API info
/*
URL: https://api.coingecko.com/api/v3/coins/markets?vs_currency=usd&ids=limit&order=market_cap_desc&per_page=100&page=1&sparkline=true&price_change_percentage=24h
